    ...
    public partial class ViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public bool IsConnectingByCode
        {
            ...
            set
            {
                if (_isConnectingByCode != value)
                {
                    ...
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(IsConnectingByCode)));
                }
            }
        }
        ...
        public string ConnectionCode
        {
            ...
            set
            {
                ...
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(ConnectionCode)));
            }
        }
